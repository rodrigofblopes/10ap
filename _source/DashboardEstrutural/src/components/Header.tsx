  ...
  return (
    <header className="bg-gradient-to-r from-black via-yellow-600 to-black text-white shadow-lg border-b-2 border-yellow-400">
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
        {/* Primeira linha: Logo e Nome da Empresa - Lado Esquerdo */}
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-3">
            <img 
              src="/BIMTECH.jpg" 
              alt="BIMTECH Logo" 
              className="h-10 w-10 sm:h-12 sm:w-12 object-contain flex-shrink-0 rounded-lg bg-white p-1"
            />
            <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 px-3 sm:px-4 py-1 sm:py-2 rounded-lg shadow-lg">
        ...
        {/* Segunda linha: Título do Projeto Centralizado */}
